...
1. **Import All Pages**
   ...
   - Select all pages from to the [GBEdeck.com](https://gabriel-velez.github.io/GBE-Deck/) and import them into TouchPortal
...
🌐 [GBEdeck.com](https://gabriel-velez.github.io/GBE-Deck/)
